    ...
    <ChartContainer title="Flow Rate Sensitivity" icon={TrendingUp} height={height}>
      <LineChart data={data} margin={CHART_DEFAULTS.margin}>
        ...
        <XAxis
          ...
          label={{ value: 'Flow Rate (gpm)', position: 'insideBottom', offset: -5, fill: CHART_DEFAULTS.axisColor }}
        />
        <YAxis
          stroke={CHART_DEFAULTS.axisColor}
          tick={{ fill: CHART_DEFAULTS.axisColor, fontSize: 12 }}
        ...
        <ReferenceLine y={1.0} stroke="#22c55e" strokeDasharray="5 5" label={{ value: 'HCI=1.0 (Good)', fill: '#22c55e', position: 'right' }} />
        <ReferenceLine y={0.55} stroke="#ef4444" strokeDasharray="5 5" label={{ value: 'CTR=0.55 (Min)', fill: '#ef4444', position: 'right' }} />
      </LineChart>
    </ChartContainer>
  );
};
